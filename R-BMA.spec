...
Version  : 3.18.19
Release  : 33
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/BMA_3.18.19.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/BMA_3.18.19.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731637183
...
/usr/lib64/R/library/BMA/tests/run_tests.R
/usr/lib64/R/library/BMA/tests/test_functions.R

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/BMA/libs/BMA.so
/V4/usr/lib64/R/library/BMA/libs/BMA.so
